...
let forEach = zooAnimals.forEach(i => displayNames.push(i.animal_name + ' ' + i.scientific_name))
...
*/
const animalNames = zooAnimals.map(i => i.animal_name)
const lowCaseAnimalNames = animalNames.map(i => i.toLocaleLowerCase())
...
let animalPopulation = zooAnimals.reduce((arr, i) => arr += i.population, 0)
